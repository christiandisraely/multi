    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title" id="editarClienteModalLabel">Editar Cliente</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <img src="{{ asset('images/49585_human_male_user_icon.png') }}" alt="Imagen del Modal" class="img-fluid"
            ...
            <form id="editarClienteForm" action="{{ route('clientes.update', ['id' => 0]) }}" method="POST">
                ...
                <div class="modal-footer">
                    <!-- Asegúrate de que el botón esté dentro de un formulario para enviar los datos -->
                    <button type="submit" class="btn btn-primary">Actualizar <i class="fa-regular fa-pen-to-square"></i></button>
                </div>
